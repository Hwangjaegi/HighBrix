...
public class AccountAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) {
		...
		int total = bd.getTotal(); 	//일단 board1으로사용	약 238개
