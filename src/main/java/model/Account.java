...
public class Account {
	...
	private int a_ref;			//답변글그룹
	private int a_step;			//답변글순서
	private int a_level;		//답변글 들여쓰기
	private String a_del;		//게시글삭제여부
	private String id;			//member id정보 저장
	private String name;		//member 이름 저장용 변수 -> table x
